...
function GameApp:event(e, ...)
	...
	elseif (canHandleKeyboard and e[0].type == sdl.SDL_KEYDOWN) or e[0].type == sdl.SDL_KEYUP then
		local press = e[0].type == sdl.SDL_KEYDOWN
		self:processButtonEvent(press, sdl.SDL_KEYDOWN, e[0].key.keysym.sym)
	elseif (canHandleMouse and e[0].type == sdl.SDL_MOUSEBUTTONDOWN) or e[0].type == sdl.SDL_MOUSEBUTTONUP then
