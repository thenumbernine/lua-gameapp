...
function GameApp:event(e, ...)
	...
	elseif (canHandleKeyboard and e[0].type == sdl.SDL_EVENT_KEY_DOWN) or e[0].type == sdl.SDL_EVENT_KEY_UP then
		local press = e[0].type == sdl.SDL_EVENT_KEY_DOWN
		self:processButtonEvent(press, sdl.SDL_EVENT_KEY_DOWN, e[0].key.key)
	elseif (canHandleMouse and e[0].type == sdl.SDL_EVENT_MOUSE_BUTTON_DOWN) or e[0].type == sdl.SDL_EVENT_MOUSE_BUTTON_UP then
